...
*3,544 on-chain settlements from 60 distinct agent wallets · $23.06 in test USDC, settled on Arc — generated by the reproducible load harness below, not organic external demand.*
