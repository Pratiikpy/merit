...
const PAGES = ["/", "/verify.html", "/proof.html", "/statement.html", "/jury.html", "/compliance.html", "/break.html", "/honesty.html", "/benchmark.html", "/onboard.html", "/passport.html", "/brandkit"];
